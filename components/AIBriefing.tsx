    ...
    <div className="rounded-xl border border-border bg-surface overflow-hidden">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          {cached && (
            <span className="font-mono text-[9px] text-text-muted bg-surface-hover px-2 py-0.5 rounded">
              CACHED
            </span>
          )}
        </div>
                ...
                <>
                  <pre className="font-mono text-xs text-text-secondary whitespace-pre-wrap leading-relaxed">
                    ...
                    {charIdx < report.length && (
                      <span className="inline-block w-0.5 h-3 bg-primary/60 animate-pulse ml-0.5" />
                    )}
                  </pre>
                  {charIdx >= report.length && (
                    <button
                      ...
                      disabled={loading}
                      className="mt-4 flex items-center gap-2 font-mono text-[10px] uppercase tracking-widest text-text-muted hover:text-text-primary transition-colors"
                    >
                    ...
                    <div className="mt-6 border-t border-border pt-4">
                      ...
                      <div className="bg-black/50 border border-border rounded-lg p-3">
                        <div className="flex justify-between items-end mb-2">
                          <p className="font-mono text-xs text-text-primary">Estimated Burn Rate</p>
