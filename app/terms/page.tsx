    ...
    <div className="min-h-screen bg-background text-text-primary px-6 py-12">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="prose prose-invert prose-sm font-mono text-text-secondary space-y-6">
          ...
          <section>
            <h2 className="text-text-primary text-base">1. Acceptance of Terms</h2>
          ...
          <section>
            <h2 className="text-text-primary text-base">2. Service Description</h2>
          ...
          <section>
            <h2 className="text-text-primary text-base">3. User Responsibilities</h2>
          ...
          <section>
            <h2 className="text-text-primary text-base">4. Subscription and Billing</h2>
