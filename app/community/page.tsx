      ...
      <div className="max-w-2xl mx-auto z-10 relative">
        ...
        {loading ? (
          <div className="flex justify-center py-20">
            <div className="animate-pulse w-32 h-4 bg-surface-hover rounded" />
          </div>
        ) : (
          <div className="space-y-6">
            <div className="flex bg-background p-1 rounded-xl border border-border mb-8 w-fit mx-auto">
              <button 
                onClick={() => setActiveTab("feed")} 
                className={`px-6 py-2 rounded-lg text-xs font-mono uppercase tracking-widest transition-all ${activeTab === "feed" ? "bg-surface-active text-text-primary" : "text-text-muted hover:text-text-primary"}`}
              >
                Global Feed
              </button>
              <button 
                onClick={() => setActiveTab("squad")} 
                className={`px-6 py-2 rounded-lg text-xs font-mono uppercase tracking-widest transition-all ${activeTab === "squad" ? "bg-surface-active text-text-primary" : "text-text-muted hover:text-text-primary"}`}
              >
                My Squad
              </button>
            </div>
            ...
            {activeTab === "feed" ? (
                ...
                >
                  <div className="flex justify-between items-start mb-3">
                    <div className="flex items-center gap-2">
                      <div className="w-6 h-6 rounded-full bg-surface-active flex items-center justify-center font-mono text-[8px] uppercase">
              ...
              <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
                <div className="bg-background border border-border rounded-2xl p-6 text-center">
                  <h2 className="text-xl font-medium tracking-tight text-text-primary mb-2">Debt-Free Pods</h2>
                  ...
                  <div className="flex justify-center items-center gap-8 mb-8">
                    ...
                    <div className="flex flex-col items-center gap-2 opacity-50">
                      <div className="w-14 h-14 rounded-full border-2 border-dashed border-border-hover flex items-center justify-center font-mono text-xl">+</div>
                  ...
                  <div className="p-4 bg-surface-hover rounded-xl border border-border mb-6">
                    ...
                    <p className="font-bold text-3xl font-numeric text-text-primary">99<span className="text-lg text-text-muted">/100</span></p>
                  </div>
